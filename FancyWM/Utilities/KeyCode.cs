...
namespace FancyWM.Utilities
{
    public static class KeyCodeHelper
    {
        ...
        public static (IReadOnlyList<KeyCode> Modifiers, KeyCode Key) GetModifierAndKeyCode(IEnumerable<KeyCode> keys)
        {
            ...
            var nonModifiers = keys.Where(x => !modifiers.Contains(x)).ToArray();
            if (nonModifiers.Length != 1)
            {
                throw new ArgumentException(nameof(keys));
            }

            return (modifiers, nonModifiers[0]);
        }

        public static KeyCode MapToKeyCode(Key key)
        {
            return key switch
            {
                ...
                Key.AbntC1 => KeyCode.None,
                Key.AbntC2 => KeyCode.None,
                Key.Oem4 => KeyCode.Oem4,
                Key.Oem5 => KeyCode.Oem5,
                Key.Oem6 => KeyCode.Oem6,
                Key.Oem7 => KeyCode.Oem7,
                Key.Oem8 => KeyCode.Oem8,
                Key.Oem102 => KeyCode.Oem102,
                Key.ImeProcessed => KeyCode.None,
                Key.System => KeyCode.None,
                Key.DbeAlphanumeric => KeyCode.None,
                Key.DbeKatakana => KeyCode.None,
                Key.DbeHiragana => KeyCode.None,
                Key.DbeSbcsChar => KeyCode.None,
                ...
                Key.DbeNoCodeInput => KeyCode.None,
                Key.DbeDetermineString => KeyCode.None,
